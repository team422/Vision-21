...
public static class CellPipeline implements VisionPipeline {
	...
	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = {8.093525179856115, 34.09556313993174};

		double[] hsvThresholdSaturation = {94.01978417266191, 255.0};
  ...
  public static void main(String... args) {
    ...
    //experimental NetworkTables stuff 
    NetworkTable table = ntinst.getTable("visionTable");
    NetworkTableEntry test = new NetworkTableEntry(ntinst, 1);
    NetworkTableEntry x = new NetworkTableEntry(ntinst, 2);
    NetworkTableEntry y = new NetworkTableEntry(ntinst, 3);
    NetworkTableEntry correction = new NetworkTableEntry(ntinst, 4);
